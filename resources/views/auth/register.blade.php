                ...
                <div class="panel-body bg-success">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('acc_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="acc_id" type="text" class="form-control" name="acc_id" value="{{ old('acc_id') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('is_admin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="radio-inline"><input type="radio" name="is_admin" value="1">بله</label>
                        ...
                        <div class="form-group{{ $errors->has('is_super_admin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="radio-inline"><input type="radio" name="is_super_admin" value="1">بله</label>
