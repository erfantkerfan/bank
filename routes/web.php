...
Route::middleware(['logindate'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/pdf/all/{id}/',[ExportController::class, 'full'])->name('full_export');
    ...
    Route::middleware(['auth','AdminAuth'])->group(function () {
        ...
        Route::get('/pdf/transaction',[ExportController::class, 'transaction'])->name('admin_transaction_export');
